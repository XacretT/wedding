  ...
  <div className="container g-pt-100">
    <div className="row justify-content-between">
      <div className="col-md-5 align-self-center">
        <h2 className="g-color-black g-font-size-36 text-uppercase g-line-height-1_2 g-mb-30">Revolution in Growing
          <br /><span className="g-font-weight-700">H-Type Installation</span></h2>
...
<section>
  ...
  <div className="text-center g-pb-50 g-pt-50">
    ...
    <p className="lead mb-0">H-type installation are a unique development of Ponics Technologies. These systems are designed and optimized to create optimal conditions for growing plants. Pre-designed flexibility allows you to grow greens, variety of determinant plants and micro-greens.<br />
    <br />Installations of this type can be made to order with any dimensional characteristics and number of tiers</p>
  </div>
...
<div className="sketchfab-embed-wrapper"><iframe width={600} height={380} src="https://sketchfab.com/models/1189d7b8b90f4ae8b0d2115b7e2b3595/embed" frameBorder={0} allowvr allowFullScreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel /> </div>
