    ...
    <div className="col-md-6 col-lg-5">
      <div className="g-mt-0--md ">
        <div className="g-mb-20">
          <h2 className="g-color-primary poiret-main g-font-weight-600 g-font-size-25 g-font-size-35--lg g-line-height-1_2 mb-4 text-uppercase">Трансфер
          </h2>
          <p className="g-font-size-25 g-color-gray-light-v3 poiret-main">Утром к 8:00 - 8:30 к Вам прибудет автомобиль, который и отвезет Вас на торжество</p>
        </div>
      </div>
    </div>
