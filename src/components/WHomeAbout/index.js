...
<section id="tours" className="g-bg-gray-dark-v1 g-py-100">
  <div className="container text-center g-width-880 g-mb-65">
    ...
    <p className="mb-0 g-font-size-30 g-color-gray-light-v3 lead invitation">это компас, который ведет нас, она является источником вдохновения для достижения больших высот инашего комфорта, когда мы иногда колеблемся </p>
